       ...
       // string RxString;
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            try
            {
              ...
              //  textBox.Invoke(new Action(delegate ()
              //  {
            //        textBox.AppendText(Convert.ToString(serialPort.BaudRate));
            ...
            //    }));
                ...
                if (String.Equals(cBoxExcell.Text, "space"))
                {
                    textBox.Invoke(new Action(delegate ()
                    {
                        textBox.AppendText("sep= " + "\r\n");
                ...
                if (String.Equals(cBoxExcell.Text, "TAB"))
                {
                textBox.Invoke(new Action(delegate ()
                {
                    textBox.AppendText("sep=/t" + "\r\n");
